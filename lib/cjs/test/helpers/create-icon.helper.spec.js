...
var create_icon_helper_1 = require("../../src/helpers/create-icon.helper");
describe('Helper', function () {
    ...
    describe('createIcon', function () {
        it('should return 5 icons classes to render', function () {
            ...
            var result = create_icon_helper_1.createIcon({ rating: rating, icons: icons, iconsNumber: iconsNumber });
