...
var PrettyRating = function (_a) {
    var value = _a.value, _b = _a.icons, icons = _b === void 0 ? config_1.defaultValues.icons : _b, _c = _a.max, max = _c === void 0 ? config_1.defaultValues.max : _c, _d = _a.colors, colors = _d === void 0 ? config_1.defaultValues.colors : _d, onChange = _a.onChange;
    var _e = (0, react_1.useState)(), iconsToRenderState = _e[0], setIconsToRenderState = _e[1];
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, iconsToRenderState === null || iconsToRenderState === void 0 ? void 0 : iconsToRenderState.map(function (icon, i) {
        return (react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { key: i, icon: typeof icon.name === 'string' ? icon.name : icon.name, style: {
            ...
            }, onMouseEnter: function () { return handleOnMouseEnter(i + 1); }, onMouseLeave: function () { return handleOnMouseLeave(); }, onClick: function () { return handleOnChange(i + 1); } }));
    })));
};
