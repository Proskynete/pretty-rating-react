...
export var PrettyRating = function (_a) {
    var value = _a.value, _b = _a.icons, icons = _b === void 0 ? defaultValues.icons : _b, _c = _a.max, max = _c === void 0 ? defaultValues.max : _c, _d = _a.colors, colors = _d === void 0 ? defaultValues.colors : _d, onChange = _a.onChange;
    var _e = useState(), iconsToRenderState = _e[0], setIconsToRenderState = _e[1];
    useEffect(function () {
